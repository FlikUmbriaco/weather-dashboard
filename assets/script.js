var apiKey = "de88a507c38fb9956114f13794fc85fd";
...
function currentCondition(city) {
    ...
    $.ajax({
      ...
      //show current city, temp, humidity, and wind speed
        var currentCity = $(`
            <h2 id="currentCity">
        ...
        $.ajax({
            ...
            //show colors related to different UV and weather statuses.
...
function futureCondition(lat, lon) {
    ...
    $.ajax({
        ...
        for (let i = 1; i < 6; i++) {
            ...
            //display the date, weather icon conditions, temp, and humidity
...
//search local data for last searched city
